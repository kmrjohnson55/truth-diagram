    ...
    >
      <div className="space-y-5">
        ...
        <div className="text-xs text-slate-400 bg-slate-50 rounded-lg p-3">
          <strong>Try it:</strong> Drag the box up to increase sensitivity (more TP, fewer FN). Drag it right to increase specificity (more TN, fewer FP). Notice how improving one tends to worsen the other &mdash; this is the fundamental tradeoff of diagnostic testing.
        </div>
      </div>
    </LessonLayout>
  );
